...
function TrouverProfessionnel() {
  ...
  async function loadData() {
    ...
    try {
      ...
      // Filtrer uniquement les médecins (profession === 'Médecin')
      const medecins = Array.isArray(staffData) 
        ? staffData.filter(s => s.profession === 'Médecin')
        : [];
      setStaff(medecins);
      setFilteredStaff(medecins);

      // Extraire les spécialités uniques (à partir des médecins)
